...
def add_all_builders(deployment_file: str):
    ...
    artifact_builder._deploy_all_regions(record=record, workers_zip_data=workers_zip_data)
    layer_builder._deploy_all_regions(record=record, workers_zip_data=workers_zip_data)
